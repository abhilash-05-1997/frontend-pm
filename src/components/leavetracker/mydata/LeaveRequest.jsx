  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 dark:bg-dark-bg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <h1 className="text-3xl font-bold text-gray-900 mb-6 dark:text-dark-text">Leave Requests</h1>

        {/* Loading State */}
        {loading ? (
          <div className="flex justify-center items-center">
            <div className="w-12 h-12 border-4 border-t-transparent border-blue-500 rounded-full animate-spin"></div>
            <span className="ml-4 text-gray-700 dark:text-dark-text">Loading...</span>
          </div>
